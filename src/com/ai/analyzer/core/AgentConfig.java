...
public class AgentConfig {
    ...
    private List<com.ai.analyzer.agent.mcpclient.CustomMcpConfig> customMcpConfigs = Collections.emptyList();
    ...
    public List<com.ai.analyzer.agent.mcpclient.CustomMcpConfig> getCustomMcpConfigs() {
        return customMcpConfigs != null ? customMcpConfigs : Collections.emptyList();
    }

    private static List<com.ai.analyzer.agent.mcpclient.CustomMcpConfig> parseCustomMcpConfigs(String json) {
    ...
    public String getSkillsDirectoryPath() { return skillsDirectoryPath != null ? skillsDirectoryPath : ""; }
    public void setSkillsDirectoryPath(String skillsDirectoryPath) { this.skillsDirectoryPath = skillsDirectoryPath != null ? skillsDirectoryPath : ""; }
